...
# $Header: /var/cvsroot/gentoo-x86/net-misc/whois/whois-5.1.5.ebuild,v 1.4 2014/10/10 20:13:11 maekke Exp $
...
src_compile() {
	...
	tc-export CC
	use elibc_uclibc && emake CFLAGS="${CFLAGS} ${CPPFLAGS} -liconv" \

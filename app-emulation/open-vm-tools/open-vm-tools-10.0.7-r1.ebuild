...
PATCHES=(
	...
	"${FILESDIR}/${P}-support-building-against-libtirpc.patch"
	"${FILESDIR}/${P}-do-not-assume-linux-and-glibc-are-the-same.patch"
	"${FILESDIR}/${P}-rename-poll.h-to-vm_poll.h.patch"
	"${FILESDIR}/${P}-use-configure-test-for-struct-timespec.patch"
	"${FILESDIR}/${P}-fix-definition-ALLPERMS-and-ACCESSPERMS.patch"
	"${FILESDIR}/${P}-use-configure-to-test-for-feature-instead-of-platform.patch"
...
src_prepare() {
	...
	mv ${S}/lib/include/poll.h ${S}/lib/include/vm_poll.h

...
EAPI="5"
inherit autotools multilib user flag-o-matic
...
src_prepare() {
	...
	use elibc_musl && epatch "${FILESDIR}"/${PN}-2.9.8.2-ifdef-mpls.patch
...
src_configure() {
	...
	use elibc_musl && append-cflags -I${EPREFIX}/usr/include/tirpc

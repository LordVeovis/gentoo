...
IUSE="asterisk doc irc java memcached minimal mysql postgres selinux ssl"
...
src_install() {
	...
	if -d /usr/libexec/munin; then
		dosym /usr/share/munin /usr/libexec/munin
	fi
...
pkg_postinst() {
	...
	elog "If this is an upgrade, please do ln -s /usr/share/munin /usr/libexec/munin"
}

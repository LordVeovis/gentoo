...
HTTP_PASSENGER_MODULE_P="nginx-passenger-${HTTP_PASSENGER_MODULE_PV}"
HTTP_PASSENGER_MODULE_URI="https://s3.amazonaws.com/phusion-passenger/releases/passenger-${HTTP_PASSENGER_MODULE_PV}.tar.gz"
HTTP_PASSENGER_MODULE_WD="${WORKDIR}/passenger-${HTTP_PASSENGER_MODULE_PV}/src/nginx_module"
...
CDEPEND="
	...
	nginx_modules_http_passenger? ( dev-ruby/rake dev-lang/ruby )
...
src_prepare() {
	...
	if use nginx_modules_http_passenger; then
		cd "${HTTP_PASSENGER_MODULE_WD}/.." || die

		eapply "${FILESDIR}"/passenger-5.0.30-isnan.patch
	fi

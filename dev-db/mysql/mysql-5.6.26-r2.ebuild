...
inherit toolchain-funcs mysql-multilib flag-o-matic
...
# this is OK as long as we call the "right" *_src_prepare
src_prepare() {
	mysql-multilib_src_prepare

	epatch "${FILESDIR}"/${PN}-5.6.24-musl.patch
	use elibc_musl && append-cflags -D__STDC_ISO_10646__
}
